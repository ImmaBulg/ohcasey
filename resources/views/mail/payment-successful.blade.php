                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody" width="765px" style="
                                ...
                                <tr>
                                    <td style="padding: 0px 60px;  padding-bottom: 20px;">
                                        ...
                                        padding-bottom: 10px;
                                        font-weight: 400;
                                        text-align: left;">Ваша оплата заказа №{{$order->order_id}} на сумму {{ $payment->amount }} руб прошла успешно.</span>
                                        <span style="display: block;
                                        color:  #000000;
                                        font-size: 14px;
                                        padding-top: 10px;
                                        padding-bottom: 10px;
                                        font-weight: 400;
                                        text-align: left;">Менеджер Ohcasey свяжется с вами, когда заказ будет готов.</span>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END PREHEADER -->
