	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable"
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody" width="765px" style="
								...
								<tr>
									<td style="padding: 0px 60px;  padding-bottom: 20px;">
										...
										padding-bottom: 10px;
										font-weight: 400;
										text-align: left;">Благодарим вас за заказ.</span>
										<span style="display: block;
										color:  #000000;
										font-size: 14px;
										padding-top: 10px;
										...
										font-size: 16px;">{{ $order->client_name or '-' }}</span></span>
										<span style="display: block;
										color:  #000000;
										font-size: 14px;
										padding-top: 3px;
										...
										font-size: 16px;">{{ $order->country->country_name_ru or '-' }}</span></span>
										<span style="display: block;
										color:  #000000;
										font-size: 14px;
										padding-top: 3px;
										...
										font-size: 16px;">{{ $order->delivery->delivery_caption or '-' }}</span></span>
										...
										font-size: 16px;">{{ $order->deliveryCdek->city->city_name or '-' }}</span></span>
										...
										font-size: 16px;">{{ $order->deliveryCdek->cdek_pvz_address or '-' }}</span></span>
												<span style="display: block;
										color:  #000000;
										font-size: 14px;
										padding-top: 3px;
										...
										font-size: 16px;">{{ $order->deliveryCdek->cdek_pvz_worktime or '-' }}</span></span>
											@endif
										@endif
										...
										font-size: 16px;">{{ $order->delivery_date or '-' }}</span></span>
										@endif
										<span style="display: block;
										color:  #000000;
										font-size: 14px;
										...
										<div style="letter-spacing: normal; display: block; background: #2F6EA3;  height:50px; padding-top: 12px; text-transform: uppercase; color: white; width:200px; margin-left: 220px; margin-top: 38px;     text-align: center;">Итого: {{ $order->order_amount + $order->delivery_amount }} рублей</div>
									</td>
								</tr>
							</table>
							<!-- // END PREHEADER -->
		...
		<tr>
			<td style="background-repeat: no-repeat; display: block; margin-top:-20px; background: url({{ url('img/mail_background.png') }}); vertical-align: top; padding: 60px 110px ;" height="411px" width="640px">
				<span style="font-size: 14px; letter-spacing: normal; line-height: 18px;">
					<nobr>Если все верно, скоро с вами свяжется оператор для подтверждения заказа.</nobr>
					<br><nobr>В противном случае позвоните в службу доставки по телефону <a style="color:#405e88!important; font-size: 16px; text-decoration: none"
									href="tel:79653969785" title="Наш телефон">+7(965)396-97-85</a></nobr>
				</span>
