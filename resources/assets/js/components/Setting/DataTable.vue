...
<div>
    <div class="form-group">
        <router-link :to="{name: 'setting.create'}" class="btn btn-success">Добавть настройку</router-link>
    </div>
    <div class="row">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr v-for="row in rows.data">
                    ...
                    <td><router-link :to="{ name: 'setting.edit', params: { id: row.id } }"><i class="fa fa-pencil" aria-hidden="true"></i></router-link></td>
                    <td><a :id="'delete-' + row.id" data-confirm="Удалить тег?" @click="destroy({id: row.id, key: 'setting'})"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        data(){
            return {
                fields: [
                    ...
                    {key: 'type', name: 'Тип', type: 'string'},
                    {key: 'group', name: 'Группировка', type: 'string'}
