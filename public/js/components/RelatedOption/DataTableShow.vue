    ...
    export default {
        data(){
            return {
                ...
                rowsRoute: lroutes.api.admin.ecommerce.related_option.show.replace(/{.*}/, this.$route.params.id),
            }
        },
        ...
        methods: {
            changeActive(row){
                ...
                let settings = {
                    method: 'post',
                    path: lroutes.api.admin.ecommerce.related_option_value.update.replace(/{.*}/, row.id),
                    params: {
                        active: !!!row.active,
                    }
                }
